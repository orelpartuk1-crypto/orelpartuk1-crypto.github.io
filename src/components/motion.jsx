...
// The height change itself animates smoothly — `layout` on this panel below
// is what makes that a real expansion rather than a snap. Resets to
// collapsed each time the sheet reopens.
